...
A Python 3 program to convert a font files into a Python module, to be used by LCD module like st7920.py. Currently supports monospaced, 8 bits PNG font sheet. The font4x6.py and font6x8.py were generated by this program.
